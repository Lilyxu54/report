<template>
  <div class="home">
    ...
    <div class="homeright">
      ...
      <el-pagination
        style="margin-top: -50px;position: absolute;left: 125px;"
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      // console.log(index, 'https//'+row.report_url);
      window.open("https://" + row.report_url);
    },
    submitUpload() {
    ...
    handleNodeClick(data) {
      this.upLoadData.areaCode = data.id;
    ...
    async queryreport() {
      try {
        ...
        if (contdata.code == undefined||contdata == []) {
