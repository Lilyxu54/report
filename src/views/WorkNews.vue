  ...
  <div class="home">
    <div class="homeleft">
      ...
      <el-dialog :visible.sync="dialogVisible">
        <img width="100px" height="100px" :src="dialogImageUrl" alt  />
      </el-dialog>
    ...
    <div class="homeright">
      ...
      >
        ...
        >
          ...
          <el-tag type="danger" style="float: right;margin-top: -20px;" @click="delquery">删除</el-tag>
        </el-collapse-item>
      </el-collapse>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    handleChange(val) {
      console.log(val);
      let arr = [val];
      this.delrowcontent = arr[arr.length - 1];
